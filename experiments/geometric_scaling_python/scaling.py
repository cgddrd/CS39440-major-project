...
# Double slash on the argument to make it an optional argument.
# parser.add_argument("--image1", help="the first image")
parser.add_argument("image1", help="the first image")
parser.add_argument("image2", help="the second image")
args = parser.parse_args()

if args.image1:
    # String format in Python.
    print "verbosity turned on - {0}".format(args.image1)
