...
%\begin{figure}[ht!]
%\centering
%\includegraphics[scale=0.48]{stage2.png}
...
%\begin{figure}[ht!]
%\centering
%\includegraphics[scale=0.38]{stage3.png}
...
%\begin{figure}[ht!]
%\centering
%\includegraphics[scale=0.36]{stage4.png}
%\end{figure}
%
%\end{frame}
%
...
%\vspace{-10pt}
%
%Outliers are removed by ignoring any recorded values that lie outside of (\texttt{Factor x Median}) of the mean.
%
%\end{frame}
%
%\begin{frame}{Experiment One - Multiple Small Patches}
