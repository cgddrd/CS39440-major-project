...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.1]{images/rig_setup}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.5]{images/camera_flow.pdf}
