...
class TestTSEUtils(TestCase):
    ...
    def test_get_smallest_key_dict(self):
        ...
        assert_equal(TSEUtils.get_smallest_key_dict(test_dict), -1, "Smallest key should equal 2")

    def test_get_largest_key_dict(self):
        test_dict = {-1: 'value_-1', 1: 'value_1', 2: 'value_2'}
        assert_equal(TSEUtils.get_largest_key_dict(test_dict), 2, "Largest key should equal 2")

    def test_get_smallest_key_value_dict(self):
        test_dict = {-1: 'value_-1', 1: 'value_1', 2: 'value_2'}
        assert_equal(TSEUtils.get_smallest_key_value_dict(test_dict), "value_-1",
                     "Smallest value should equal 'value_-1'")

    def test_string_list_to_int_list(self):
        test_string_2d_list = [["1", "2"], ["3", "4"]]

        test_string_2d_to_int_2d_list = TSEUtils.string_2d_list_to_int_2d_list(test_string_2d_list)
    ...
    def test_convert_to_int(self):
        ...
        test_string_to_int_list = TSEUtils.convert_list_to_int(test_string_list)
    ...
    def test_calc_moving_average_array(self):
        ...
        np.testing.assert_equal(TSEUtils.calc_moving_average_array(test_data, points_to_average), expected_result)
        assert_true(np.array_equal(TSEUtils.calc_moving_average_array(test_data, points_to_average), expected_result))
    ...
    def test_convert_array_to_numpy_array(self):
        ...
        assert_true(np.array_equal(TSEUtils.convert_array_to_numpy_array(test_data), expected_result))
    ...
    def test_calc_cartesian_product(self):
        ...
        assert_true(np.array_equal(TSEUtils.calc_cartesian_product([test_data1, test_data2]), expected_result))
        assert_true(np.array_equal(TSEUtils.calc_cartesian_product([test_data3, test_data4]), expected_result2))